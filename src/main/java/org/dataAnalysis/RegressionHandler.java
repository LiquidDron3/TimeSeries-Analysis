...
public class RegressionHandler {
    ...
    private static int[] getRegressionParameters(String selectedRegression) {
    ...
    protected static double[] calculateHistoryDataSetOfRegression(Model regression, int lengthOfInputDataSet) {
        if(isInstanceAutoRegressionType(regression)) {
            throw new IllegalArgumentException(Messages.ERROR_UNKNOWN_REGRESSION);
        }
    ...
    protected static double[] calculateFutureDataSetOfRegression(Model regression, int predictionPoint) {
