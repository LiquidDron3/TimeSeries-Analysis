...
public class RegressionHandlerTest {
    ...
    public void setUp() {
        ...
        HTMLDocument document = Mockito.mock(HTMLDocument.class);
        regressionHandler = new RegressionHandler(document);
    }
    ...
    public void checkDatasetCalculationForSimpleLinearReg() {
        ...
        double[] calculatedDataSet = regressionHandler.createDataSetForRegression(simpleLinearRegression, inputDataLength,
                predictionPoint);
    ...
    public void checkDatasetCalculationForAutoRegressionFamily() {
        ...
        double[] calculatedDataSet = regressionHandler.createDataSetForRegression(autoRegression, inputDataLength,
                predictionPoint);
